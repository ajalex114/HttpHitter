...
namespace HttpExecutor.Formulators
{
    ...
    sealed class FormulateRandomRequests : AbstractFormulateRequestor
    {
        public FormulateRandomRequests() { }
        ...
        public override IEnumerable<ExecutorRequest> FormulateRequests()
        {
            ...
            var requestAlgorithm = Provider.GetRequestAlgorithm(Order.Sequential);
